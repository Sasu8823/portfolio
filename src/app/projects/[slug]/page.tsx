...
URL; 非公開`,
    ...
    description: `「私の性格診断」を実施しました。

親の属性を特定しました。

さらに、属性を特定するために、以下の質問が適切だと考えました。
・質問は、遠くに住んでいる子どもでも答えやすいものにしてください。
・質問は10～20個以内（子どもが答えられない場合は、「わかりません」と答えてください）。
・回答結果はメッセージ生成に使用され、AIによって分析されます。

1 あなたのご両親は、日常生活でユーモアやジョークをよく使うタイプだと思いますか？
→（明るく軽快な口調を好むかどうかを判断するのに役立ちます。）

2 あなたのご両親は、他人や家族の話を穏やかに聞く、聞き上手なタイプだと思いますか？
→（共感や感謝の気持ちを表すのが得意かどうかを判断するのに役立ちます。）

3 あなたのご両親は、いつも規則正しく、几帳面な生活を送っているように見えますか？
→（礼儀や日頃の習慣に関するメッセージに適しています。）

④ ご両親は、写真、手紙、日記などの「思い出」を大切にするタイプだと思いますか？ →（ノスタルジアの側面を活かせるでしょうか？）

⑤ ご両親は、テレビや新聞で時事問題をよくチェックしていますか？
→（時事問題が適切かどうかを判断します。）

⑥ ご両親は、最近、人と話す機会が少ないと感じていますか？
→（「つながり」を強調したメッセージが効果的かどうかを判断します。）

⑦ ご両親は、スマートフォンや家電製品などの新しいものに抵抗を感じていますか？
→（ITリテラシーを考慮したトーンをデザインします。）

8 ご両親は、家族や親戚とのつながりを大切にしているように見えますか？
→（「家族」をキーワードに含めるかどうかを判断します。）

96 ご両親は、自分よりも他人を思いやるタイプだと思いますか？
  ...
  return (
    <main className="min-h-screen ">
      ...
      <div className="max-w-6xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-[20px] md:text-4xl font-bold text-white mb-6">{project.title}</h1>
          <p className="text-[16px] md:text-xl text-gray-300 mb-8" style={{ whiteSpace: 'pre-line' }}>{project.description}</p>
